...
namespace VuesTestDemo.Scripts {
    
    
    [System.Runtime.InteropServices.ComVisible(false)]
    public partial class a : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(a).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(a));
        ...
        private string FindResource() {
            string[] resources = typeof(a).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".a.g.xaml") || resource.Equals("a.g.xaml"))) {
                    return resource;
                }
            }
